...
export default function CompareCard() {
  ...
  return (
    <div className="bg-gray-100 py-20 px-20">
      <div className="max-w-7xl mx-auto border border-[#02618f]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5">
          <div className="hidden lg:block px-3 p-4 space-y-4 border-r border-[#02618f]  last:border-none flex-1 pt-10 ">
            <h3 className="text-center text-[#540000] font-semibold">
              Compare By:
            </h3>
            <div className="flex flex-col space-y-2 px-6">
              <button className="w-40 h-10 border border-[#02618f]  text-[#02618f] rounded">
                School Stats
              </button>
              <button className="w-40 h-10 border border-[#02618f] text-[#02618f] rounded">
                School Details
