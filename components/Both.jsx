        ...
        {Array(7)
          ...
          .map((_, index) => (
            <div
              ...
              className="flex-shrink-0 w-[25vw] h-full p-4"
            >
...
export default function CombinedComponent() {
  ...
  return (
    <div className="h-[450vh]">
      {/* Combine Aisi owl animation */}
      <Aisi />
      <div
        ref={containerRef}
        className="w-full h-screen bg-blue-400 flex justify-end items-center overflow-hidden relative"
      >
        <div className="absolute top-10 left-10 text-4xl font-bold text-white z-10">
          FEATURED SCHOOL
        </div>

        {/* Circle animation for scaling and gallery */}
        <div
          ref={circleRef}
