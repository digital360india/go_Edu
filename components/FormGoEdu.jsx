...
//             <Image src="/bookingformgoedu.svg" width={1000} height={1000} alt='booking image' className='w-[50vw] h-[50vh]'/>
          
//         <div>
//             <h1 className='text-[#323232]'>Fill this form and get in touch with our counsellor</h1>
//         </div>
//     </div>
//     </>
//   )
  ...
  return (
    <div className="flex gap-20">
      ...
      <div className="w-1/2 p-8 bg-white">
        <h3 className="text-xl mb-6 text-[#323232]">Fill this form and get in touch with our counsellor</h3>
        <form onSubmit={handleSubmit} className="space-y-7">
          ...
          >
            <option value="" className='text-[#898989]'>Class</option>
            {/* Add class options */}
          </select>
          <select
            name="board"
            ...
            className=" p-2 border border-[#D9D9D9] rounded w-[143px] h-[39px] text-[#898989]"
          >
            <option value="" className='text-[#898989]'>BOARD</option>
            {/* Add board options */}
          </select>
          </div>
