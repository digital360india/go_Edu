...
export default function Counsltation({ setClose }) {
    ...
    <div className="flex items-center justify-center ">
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black z-50 p-4 bg-opacity-50 ">
        <div className="max-h-screen overflow-y-auto bg-white rounded-lg md:p-6 p-4 h-auto w-full md:max-w-[45rem] relative  lg:mx-8">
          ...
          <h2 className="text-[1.3rem] md:text-xl font-bold text-[#02618f] flex justify-between pb-5">
          ...
          <form onSubmit={handleSubmit} ref={form}>
            <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="name"
                  className="block font-semibold text-[#02618f] text-[1rem]"
                >
                  Name
                </label>
                <input
                  ...
                  required
                  className="mt-1 p-2 w-full h-[3.3rem] border border-gray-300 rounded-md text-[#02618f] placeholder-[#02618f]"
                />
              </div>
              <div>
                <label
            ...
            <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4 ">
              <div className="space-y-1">
                ...
                <select
                  ...
                  value={formData.mode}
                  onChange={handleChange}
                  className="w-full h-[3.3rem] p-2 border border-gray-300 rounded-md text-[#02618f] placeholder-[#02618f]"
                  required
                >
            ...
            <div className="flex justify-center items-center">
              <button
                type="submit"
                className="h-[3rem] w-full sm:w-[14.125rem] bg-[#02618f] text-white py-2 rounded-md hover:bg-[#02618f70] transition-colors duration-300"
              >
                Book consultation
              </button>
            </div>
